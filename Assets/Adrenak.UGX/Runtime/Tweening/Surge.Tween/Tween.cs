...
namespace Adrenak.UGX
{
    public class Tween
    {
        ...
        {
            ShakePosition tween = new ShakePosition(target, initialPosition, intensity, duration, delay, EaseLinear, startCallback, completeCallback, loop, obeyTimescale);
        ...
        {
            CanvasGroupAlpha tween = new CanvasGroupAlpha(target, endValue, duration, delay, obeyTimescale, easeCurve, loop, startCallback, completeCallback);
            SendTweenForProcessing(tween, true);
            return tween;
        }
        ...
        {
            ValueRect tween = new ValueRect(startValue, endValue, valueUpdatedCallback, duration, delay, obeyTimescale, easeCurve, loop, startCallback, completeCallback);
            SendTweenForProcessing(tween, true);
            return tween;
        }
        ...
        {
            ValueVector4 tween = new ValueVector4(startValue, endValue, valueUpdatedCallback, duration, delay, obeyTimescale, easeCurve, loop, startCallback, completeCallback);
        ...
        {
            ValueVector3 tween = new ValueVector3(startValue, endValue, valueUpdatedCallback, duration, delay, obeyTimescale, easeCurve, loop, startCallback, completeCallback);
            SendTweenForProcessing(tween);
            return tween;
        }
        ...
        {
            ValueVector2 tween = new ValueVector2(startValue, endValue, valueUpdatedCallback, duration, delay, obeyTimescale, easeCurve, loop, startCallback, completeCallback);
            SendTweenForProcessing(tween);
            return tween;
        }
        ...
        {
            ValueColor tween = new ValueColor(startValue, endValue, valueUpdatedCallback, duration, delay, obeyTimescale, easeCurve, loop, startCallback, completeCallback);
            SendTweenForProcessing(tween);
            return tween;
        }
        ...
        {
            ValueInt tween = new ValueInt(startValue, endValue, valueUpdatedCallback, duration, delay, obeyTimescale, easeCurve, loop, startCallback, completeCallback);
            SendTweenForProcessing(tween);
            return tween;
        }
        ...
        {
            ValueFloat tween = new ValueFloat(startValue, endValue, valueUpdatedCallback, duration, delay, obeyTimescale, easeCurve, loop, startCallback, completeCallback);
            SendTweenForProcessing(tween);
            return tween;
        }
        ...
        {
            ShaderVector tween = new ShaderVector(target, propertyName, endValue, duration, delay, obeyTimescale, easeCurve, loop, startCallback, completeCallback);
            SendTweenForProcessing(tween, true);
            return tween;
        }
        ...
        {
            ShaderInt tween = new ShaderInt(target, propertyName, endValue, duration, delay, obeyTimescale, easeCurve, loop, startCallback, completeCallback);
            SendTweenForProcessing(tween, true);
            return tween;
        }
        ...
        {
            ShaderColor tween = new ShaderColor(target, propertyName, endValue, duration, delay, obeyTimescale, easeCurve, loop, startCallback, completeCallback);
            SendTweenForProcessing(tween, true);
            return tween;
        }
        ...
        {
            ShaderFloat tween = new ShaderFloat(target, propertyName, endValue, duration, delay, obeyTimescale, easeCurve, loop, startCallback, completeCallback);
            SendTweenForProcessing(tween, true);
            return tween;
        }
        ...
        {
            Pitch tween = new Pitch(target, endValue, duration, delay, obeyTimescale, easeCurve, loop, startCallback, completeCallback);
            SendTweenForProcessing(tween, true);
            return tween;
        }
        ...
        {
            PanStereo tween = new PanStereo(target, endValue, duration, delay, obeyTimescale, easeCurve, loop, startCallback, completeCallback);
            SendTweenForProcessing(tween, true);
            return tween;
        }
        ...
        {
            Volume tween = new Volume(target, endValue, duration, delay, obeyTimescale, easeCurve, loop, startCallback, completeCallback);
            SendTweenForProcessing(tween, true);
            return tween;
        }
        ...
        {
            Size tween = new Size(target, endValue, duration, delay, obeyTimescale, easeCurve, loop, startCallback, completeCallback);
            SendTweenForProcessing(tween, true);
            return tween;
        }
        ...
        {
            FieldOfView tween = new FieldOfView(target, endValue, duration, delay, obeyTimescale, easeCurve, loop, startCallback, completeCallback);
            SendTweenForProcessing(tween, true);
            return tween;
        }
        ...
        {
            LightRange tween = new LightRange(target, endValue, duration, delay, obeyTimescale, easeCurve, loop, startCallback, completeCallback);
            SendTweenForProcessing(tween, true);
            return tween;
        }
        ...
        {
            LightIntensity tween = new LightIntensity(target, endValue, duration, delay, obeyTimescale, easeCurve, loop, startCallback, completeCallback);
            SendTweenForProcessing(tween, true);
            return tween;
        }
        ...
        {
            LocalScale tween = new LocalScale(target, endValue, duration, delay, obeyTimescale, easeCurve, loop, startCallback, completeCallback);
            SendTweenForProcessing(tween, true);
            return tween;
        }
        ...
        {
            RawImageColor tween = new RawImageColor(target, endValue, duration, delay, obeyTimescale, easeCurve, loop, startCallback, completeCallback);
            SendTweenForProcessing(tween, true);
            return tween;
        }
        ...
        {
            ImageColor tween = new ImageColor(target, endValue, duration, delay, obeyTimescale, easeCurve, loop, startCallback, completeCallback);
            SendTweenForProcessing(tween, true);
            return tween;
        }
        ...
        {
            TextColor tween = new TextColor(target, endValue, duration, delay, obeyTimescale, easeCurve, loop, startCallback, completeCallback);
            SendTweenForProcessing(tween, true);
            return tween;
        }
        ...
        {
            LightColor tween = new LightColor(target, endValue, duration, delay, obeyTimescale, easeCurve, loop, startCallback, completeCallback);
            SendTweenForProcessing(tween, true);
            return tween;
        }
        ...
        {
            TextMeshColor tween = new TextMeshColor(target, endValue, duration, delay, obeyTimescale, easeCurve, loop, startCallback, completeCallback);
            SendTweenForProcessing(tween, true);
            return tween;
        }
        ...
        {
            ShaderColor tween = new ShaderColor(target, "_Color", endValue, duration, delay, obeyTimescale, easeCurve, loop, startCallback, completeCallback);
            SendTweenForProcessing(tween, true);
            return tween;
        }
        ...
        {
            SpriteRendererColor tween = new SpriteRendererColor(target, endValue, duration, delay, obeyTimescale, easeCurve, loop, startCallback, completeCallback);
            SendTweenForProcessing(tween, true);
            return tween;
        }
        ...
        {
            CameraBackgroundColor tween = new CameraBackgroundColor(target, endValue, duration, delay, obeyTimescale, easeCurve, loop, startCallback, completeCallback);
            SendTweenForProcessing(tween, true);
            return tween;
        }
        ...
        {
            Position tween = new Position(target, endValue, duration, delay, obeyTimescale, easeCurve, loop, startCallback, completeCallback);
            SendTweenForProcessing(tween, true);
            return tween;
        }
        ...
        {
            AnchoredPosition tween = new AnchoredPosition(target, endValue, duration, delay, obeyTimescale, easeCurve, loop, startCallback, completeCallback);
            SendTweenForProcessing(tween, true);
            return tween;
        }
        ...
        {
            LocalPosition tween = new LocalPosition(target, endValue, duration, delay, obeyTimescale, easeCurve, loop, startCallback, completeCallback);
            SendTweenForProcessing(tween, true);
            return tween;
        }
        ...
        {
            Rotate tween = new Rotate(target, amount, space, duration, delay, obeyTimescale, easeCurve, loop, startCallback, completeCallback);
            SendTweenForProcessing(tween, true);
            return tween;
        }
        ...
        public static TweenBase Rotation(Transform target, Vector3 endValue, float duration, float delay, AnimationCurve easeCurve = null, LoopType loop = LoopType.None, Action startCallback = null, Action completeCallback = null, bool obeyTimescale = true)
        {
            ...
            Rotation tween = new Rotation(target, endValue, duration, delay, obeyTimescale, easeCurve, loop, startCallback, completeCallback);
            SendTweenForProcessing(tween, true);
            return tween;
        }
        ...
        {
            Rotation tween = new Rotation(target, endValue.eulerAngles, duration, delay, obeyTimescale, easeCurve, loop, startCallback, completeCallback);
            SendTweenForProcessing(tween, true);
            return tween;
        }
        ...
        {
            endValue = Quaternion.Euler(endValue).eulerAngles;
            LocalRotation tween = new LocalRotation(target, endValue, duration, delay, obeyTimescale, easeCurve, loop, startCallback, completeCallback);
            SendTweenForProcessing(tween, true);
            return tween;
        }
        ...
        {
            LocalRotation tween = new LocalRotation(target, endValue.eulerAngles, duration, delay, obeyTimescale, easeCurve, loop, startCallback, completeCallback);
            SendTweenForProcessing(tween, true);
            return tween;
        }
        ...
        {
            foreach (TweenBase item in activeTweens)
            {
                item.Stop();
            }
        }
